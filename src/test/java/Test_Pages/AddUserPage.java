...
public class AddUserPage extends CommonUtilities {
	...
	// By.xpath("(//a[@class=\"oxd-main-menu-item\"])[1]");
	// private final By addIcon = By.className("oxd-icon bi-plus oxd-button-icon");
	// private final By selectUserRole = By.xpath("(//div[text()='-- Select
	// --'])[1]");
	// private final By selectUserStatus = By.xpath("(//div[text()='-- Select
	// --'])[2]");
	// private final By employeeName = By.xpath("//input[@placeholder='Type for
	// hints...']");
